...
export const getParameters = (set: WaterParameters) => [
  ...
  },
  {
    ...
    isAlert: getAlertLevel(set.hardness, 0, 21) !== 'normal',
  },
  {
    name: 'Muối',
    value: `${set.salt}%`,
    icon: 'cellular-outline',
    isAlert: getAlertLevel(set.salt, 0, 0.1) !== 'normal',
  },
  {
    name: 'Nhiệt độ ngoài trời',
    value: `${set.outdoor_temp}°C`,
    icon: 'thermometer-outline',
    isAlert: getAlertLevel(set.outdoor_temp, -40, 40) !== 'normal',
  },
  {
    name: 'Oxy O₂',
    value: `${set.oxygen_o2} mg/l`,
    icon: 'water-outline',
    isAlert: getAlertLevel(set.oxygen_o2, 6.5, 100) !== 'normal',
  },
  {
    name: 'Nhiệt độ',
    value: `${set.temperature}°C`,
    icon: 'thermometer-outline',
    isAlert: getAlertLevel(set.temperature, 5, 26) !== 'normal',
  },
  {
    name: 'Giá trị pH',
    value: `${set.ph_value}`,
    icon: 'analytics-outline',
    isAlert: getAlertLevel(set.ph_value, 6.9, 8) !== 'normal',
  },
  {
    name: 'KH',
    value: `${set.kh} °DH`,
    icon: 'beaker-outline',
    isAlert: getAlertLevel(set.kh, 3.9, 100) !== 'normal',
  },
  {
    name: 'CO₂',
    value: `${set.co2} mg/l`,
    icon: 'cloud-outline',
    isAlert: getAlertLevel(set.co2, 5, 35) !== 'normal',
  },
  {
    name: 'Tổng Clo',
    value: `${set.total_chlorines} mg/l`,
    icon: 'flask-outline',
    isAlert: getAlertLevel(set.total_chlorines, 0, 0.001) !== 'normal',
  },
  {
    name: 'Lượng thức ăn',
